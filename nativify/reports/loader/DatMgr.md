...
- `src/LFW/loader/DatMgr.ts` 包含类实现，需整体设计 C++ 类的所有权、拷贝/移动语义与生命周期。
...
本文件为核心文件，已人工复核。详见：[deep-dive/loader-DatMgr.md](../deep-dive/loader-DatMgr.md)
