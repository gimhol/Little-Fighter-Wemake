# ui/component/PositionAnimation.ts

> 源文件: `src/LFW/ui/component/PositionAnimation.ts`
...
- `src/LFW/ui/component/PositionAnimation.ts` 包含类实现，需整体设计 C++ 类的所有权、拷贝/移动语义与生命周期。
